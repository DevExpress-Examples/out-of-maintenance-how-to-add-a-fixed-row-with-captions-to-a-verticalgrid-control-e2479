...
namespace WindowsFormsApplication28 {
    ...
    public partial class CarsDBDataSet : global::System.Data.DataSet {
        ...
        public partial class CarsDataTable : global::System.Data.TypedTableBase<CarsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public CarsRow AddCarsRow(string Trademark, string Model, short HP, double Liter, byte Cyl, byte TransmissSpeedCount, string TransmissAutomatic, byte MPG_City, byte MPG_Highway, string Category, string Description, string Hyperlink, decimal Price) {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`Trademark`, `Model`, `HP`, `Liter`, `Cyl`, `TransmissSpeedCo" +
                "unt`, `TransmissAutomatic`, `MPG_City`, `MPG_Highway`, `Category`, `Description`" +
                ", `Hyperlink`, `Price`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Trademark, Model, HP, Liter, Cyl, TransmissSpeedCount, TransmissAutoma" +
                "tic, MPG_City, MPG_Highway, Category, Description, Hyperlink, Price FROM Cars";
        ...
        public virtual int Update(
            ...
            if ((Original_Trademark == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_Trademark));
            }
            if ((Original_Model == null)) {
            ...
            if ((Original_HP.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((short)(Original_HP.Value));
            }
            else {
            ...
            if ((Original_Cyl.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[23].Value = ((byte)(Original_Cyl.Value));
            }
            else {
            ...
            if ((Original_TransmissSpeedCount.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[25].Value = ((byte)(Original_TransmissSpeedCount.Value));
            }
            else {
            ...
            if ((Original_TransmissAutomatic == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[27].Value = ((string)(Original_TransmissAutomatic));
            }
            if ((Original_MPG_City.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[28].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[29].Value = ((byte)(Original_MPG_City.Value));
            }
            else {
            ...
            if ((Original_MPG_Highway.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[31].Value = ((byte)(Original_MPG_Highway.Value));
            }
            else {
            ...
            if ((Original_Hyperlink == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[35].Value = ((string)(Original_Hyperlink));
            }
            if ((Original_Price.HasValue == true)) {
